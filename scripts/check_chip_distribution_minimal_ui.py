...
def main() -> None:
    ...
    assert_contains(s13_panel, "PriceBucketCountControl", 'reusable bucket count control')
    assert_contains(s13_panel, "仅此控件响应操作", 'bucket count control')
    assert_contains(s13_panel, "HitTestBehavior.opaque", 'bucket count control')
    assert_contains(s13_panel, "Slider(", 'bucket count control')
