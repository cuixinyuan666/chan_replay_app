...
def main() -> None:
    ...
    assert_contains(chip_page, "ChipDistributionSettingsController.setPriceBucketCount", 'minimal chip page')
    ...
    assert_contains(s13_panel, "chip_distribution_settings.dart", 'S13 embedded chip panel')
    ...
    print('PASS chip_distribution_page minimal UI and global bucket wiring contract')
