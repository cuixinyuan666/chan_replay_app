...
def patch_toolbox_host() -> None:
    ...
    text = replace_exact(
        ...
        '    // Quick-tool rail is disabled by product policy; do not render the\n'
        '    // left fixed "drag tools here" icon or accept dropped tools.\n'
...
"""
    text = replace_exact(text, old_list, new_list, 'replace toolbox list with controlled scrollbar')
...
def main() -> None:
    ...
    print('Drawing toolbar cleanup v2 patch applied.')
