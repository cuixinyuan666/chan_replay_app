...
def main() -> int:
    checks = {
        ...
        'single_stock_replay_page': contains('lib/ui/pages/s12_single_stock_replay_page.dart', ['enable_rhythm_1382', 'rhythm_calc_mode', 'drawingObjects: _rhythmDrawingObjects(snapshot)', 'TradingViewDrawingTool.trendLine', 'TradingViewDrawingTool.priceLabel', 'rhythm_1382_line_count', 'rhythm_1382_hit_count', 'dart_chan_calculation_authority: false']),
    }
