...
def main() -> int:
    checks = {
        'backend_overlay_module': contains('backend/app/a_rhythm_overlay_trainer.py', ['RHYTHM_RATIO = 1.382', 'with_multilevel_rhythm_overlay', "patched['rhythm_lines']", "patched['rhythm_hits']"]),
        ...
        'rhythm_settings': contains('lib/ui/pages/s13_rhythm_display_settings.dart', ['enable_rhythm_1382', 'rhythm_calc_mode', 'backendCalculationConfig']),
        'single_stock_replay_page': contains('lib/ui/pages/s13_single_stock_replay_page.dart', ['backendCalculationConfig', 'drawingObjects: _rhythmDrawingObjects(s)', 'TradingViewDrawingTool.trendLine', 'TradingViewDrawingTool.priceLabel', 'rhythm_1382_line_count', 'rhythm_1382_hit_count', 'dart_chan_calculation_authority: false']),
    }
